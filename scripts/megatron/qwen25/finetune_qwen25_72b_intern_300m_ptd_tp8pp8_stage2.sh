...
######################################################################
DATA_PATH=${LOCAL_CODE_PATH}/configs/long_vita_finetune_stage2.yaml

TOKENIZER_PATH=${ROOT_PATH}/models/Qwen/Qwen2.5-72B-Instruct/
CKPT_LOAD_DIR=${ROOT_PATH}/output/LM/scripts/modellink/qwen25/finetune_qwen25_72b_intern_300m_ptd_tp8pp8_stage1.sh/20241219_160000/
CKPT_LOAD_DIR="/"
