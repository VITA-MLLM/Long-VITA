...
from long_vita_modellink.training.utils import (
...
from long_vita_modellink.training.checkpointing import load_checkpoint

# from megatron.core.models.vision.clip_vit_model import CLIPViTModel
from long_vita_modellink.core.models.vision.clip_vit_model import CLIPViTModel
from long_vita_modellink.core.models.vision.eva_vit_model import EVA2ViTModel
from long_vita_modellink.core.models.vision.intern_vit_model import InternViTModel
from long_vita_modellink.core.models.vision.siglip_vit_model import SigLIPViTModel
from long_vita_modellink.core.models.vision.vit_layer_specs import get_vit_layer_spec
# from long_vita_modellink.core.models.vision.vit_layer_specs import get_vit_layer_with_transformer_engine_spec_for_eva
from long_vita_modellink.core.models.vision.vit_layer_specs import get_vit_layer_local_spec_for_eva
from long_vita_modellink.core.models.vision.vit_layer_specs import get_vit_layer_local_spec_for_intern
from long_vita_modellink.core.models.vision.vit_layer_specs import get_vit_layer_local_spec_for_intern_6b
from long_vita_modellink.core.models.vision.vit_layer_specs import get_vit_layer_local_spec_for_siglip
from long_vita_modellink.core.models.vision.vit_layer_specs import get_mlp_module_spec

from long_vita_modellink.core.transformer.transformer_config import VisionTransformerConfig
...
class MegatronVisionModel(torch.nn.Module):
    def __init__(self, pre_process):
        ...
        if self.vision_model_type == "intern_6b":
            ...
            vision_model_layer_spec = get_vit_layer_local_spec_for_intern_6b()
        ...
        from long_vita_modellink.core.models.vision.multimodal_projector import MultimodalProjector
        ...
        if args.vit_proj_load is not None:
            load_checkpoint([self], None, None, load_arg="vit_proj_load", args=vit_args)
...
def model_provider(pre_process=True, post_process=True) -> Union[GPTModel, megatron.legacy.model.GPTModel]:
    ...
    if args.use_mcore_models:
        from long_vita_modellink.core.models.multimodal.gpt_vl_model import GPTVLModel
...
def add_vlm_args(parser):
    ...
    group.add_argument("--vit-proj-load", type=str, help='path of vit and proj')
